...
Deceased donor kidney transplant candidates have widely varying risk of death without a transplant. The current Kidney Allocation System ignores the Final Rule requirements to rank order candidates by medical urgency. Severe racial/ethnic disparities persist within deceased donor kidney allocation which should be directly addressed by policy changes such as eliminating pre-dialysis waiting time points. With a focus on survival benefit, deceased donor kidney transplantation can save more lives.
