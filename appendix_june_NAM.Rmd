...
tibble(variable = names(w_break),
  ...
  mutate(coef = as.numeric(w_break),
    ...
    variable == "CAN_PREV_TX:immediate_post_trans" ~ "Day 0-30 post-transplant:Previous transplant",
        variable == "age_floor_25:second_post_trans_int" ~ "Day 30-18 post-transplant:Max(age -25, 0):",
    variable == "log_dial_time:second_post_trans_int" ~ "Day 30-18 post-transplant:log(years on dialysis + 1)",
    variable == "no_dial:second_post_trans_int" ~ "Day 30-18 post-transplant:Never dialyzed",
    variable == "diabetes:second_post_trans_int" ~ "Day 30-18 post-transplant:Diabetes",
    variable == "CAN_PREV_TX:second_post_trans_int" ~ "Day 30-18 post-transplant:Previous transplant",
...
# Absolute survival benefit calculation 
